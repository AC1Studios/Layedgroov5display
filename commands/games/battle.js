...
module.exports = class BattleCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            memberName: 'battle',
            description:
                'Engage in a turn-based duel against another user or the AI.',
            args: [
                {
                    key: 'opponent',
                    prompt: 'What user would you like to duel?',
                    type: 'user',
    ...
    async run(msg, { opponent }) {
        ...
        try {
            ...
            while (userHP > 0 && oppoHP > 0) {
                ...
                if (choice === 'fight') {
                    const damage =
                        Math.floor(Math.random() * (guard ? 10 : 100)) + 1;
