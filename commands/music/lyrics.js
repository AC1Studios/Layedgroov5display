...
const { geniusLyricsAPI } = require('../../data/config.json');
  ...
  async run(message, { songName }) {
    ...
    try {
      ...
      const errorEmbed = new MessageEmbed()
             ...
             .setDescription(`**[${song.full_title}](${urll})** \nis too long to display. \nVisit the source instead. \nSource: **[Click me!](${urll})**`)
             .setFooter('Lyrics is > 4095')
        return sentMessage.edit('', errorEmbed);
        }
